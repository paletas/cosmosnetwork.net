...
namespace Terra.NET.API.Serialization.Json.Messages.Wasm
{
    ...
    internal record MessageStoreCode([property: JsonPropertyName("sender")] string SenderAddress, string WasmByteCode)
        : Message(TERRA_DESCRIPTOR, COSMOS_DESCRIPTOR)
    {
        public const string TERRA_DESCRIPTOR = "wasm/MsgStoreCode";
        public const string COSMOS_DESCRIPTOR = "/cosmos.wasm.v1beta1.MsgStoreCode";

        internal override NET.Message ToModel()
        {
            return new NET.Messages.Wasm.MessageStoreCode(this.SenderAddress, this.WasmByteCode);
        }
