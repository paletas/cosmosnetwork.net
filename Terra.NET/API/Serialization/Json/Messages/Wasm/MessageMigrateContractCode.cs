...
namespace Terra.NET.API.Serialization.Json.Messages.Wasm
{
    ...
    internal record MessageMigrateContractCode([property: JsonPropertyName("sender")] string SenderAddress, ulong CodeId, string WasmByteCode)
        : Message(TERRA_DESCRIPTOR, COSMOS_DESCRIPTOR)
    {
        ...
        {
            return new NET.Messages.Wasm.MessageMigrateContractCode(this.SenderAddress, this.CodeId, this.WasmByteCode);
        }
