...
namespace CosmosNetwork.CosmWasm.Serialization
{
    ...
    internal record MessageUpdateContractAdmin(
        ...
        [property: ProtoMember(3, Name = "contract"), JsonPropertyName("contract")] string ContractAddress) : SerializerMessage(CosmWasm.MessageUpdateContractAdmin.COSMOS_DESCRIPTOR)
    {
