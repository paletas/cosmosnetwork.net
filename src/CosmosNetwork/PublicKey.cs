...
namespace CosmosNetwork
{
    public class PublicKey
    {
        ...
        public byte[] RawAddress
        {
            get
            {
                return new RIPEMD160().ComputeHash(SHA256.HashData(_key));
            }
        }

        public string Address
        {
            get { return Converter.EncodeBech32("terra", RawAddress); }
        }
        ...
        {
            return new Secp256k1Key(Convert.ToBase64String(_key));
        }
    }
