...
namespace CosmosNetwork.Ibc.Serialization.Applications.Transfer
{
    ...
    internal record MessageTransfer(
        ...
        [property: ProtoMember(3, Name = "token"), JsonConverter(typeof(DenomAmountConverter))] DenomAmount Token,
        [property: ProtoMember(4, Name = "sender"), JsonPropertyName("sender")] string SenderAddress,
        [property: ProtoMember(5, Name = "receiver"), JsonPropertyName("receiver")] string ReceiverAddress,
